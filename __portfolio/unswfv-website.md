...
<div class="alert alert-info">
  Note from the author: The organisation has ceased its operation in August 2020, the following content is the archived content as in August 2020
</div>
...
<div>
    <video width="100%" controls autoplay loop>
      <source src="/images/{{ page.folder }}/{{ "Final_v2.1.mp4" | relative_url }}" type="video/mp4">
    </video>
