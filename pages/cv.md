...
{% for skills in site.data.skills-list %}
<div class="skills-label">{{ skills.name }}</div>
{% endfor %}
...
- Dec 2021: MPSB Management Consulting
...
- Oct 2019:  Team Participant and Team Media of World Solar Challenge 2019, UNSW Solar Racing Team Sunswift
- Aug 2018:  UNTITLED - Small Projection-Mapping Work for UNSW Roundhouse, Artsweek Festival, Arc @ UNSW
- May 2018:  SYNERGY - Co-artist in Vivid Sydney 2018 | Light Installation, Sydney, Australia
