...
<img src="/images/hons-animation/storyboard_digital2-01.png" class="blog-image" alt="storyboard">

## Illustrations and Styling

<div class="row">
    <div class="col md-4">
        <img src="/images/hons-animation/colour_palettee_guide-01.png" class="card-img-top" alt="color palette">
    </div>
    <div class="col md-4">
        <img src="/images/hons-animation/object-illustrations.png" class="card-img-top" alt="illustrations">
    </div>
</div>

## Animation Sequences (Extract)

<img src="/images/hons-animation/ae-composition.png" class="card-img-top" alt="workflow and composition">
...
<div class="resp-container">
    <iframe class="resp-iframe" src="https://player.vimeo.com/video/335761585" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
</div>
